<?php
    try
        { 
            ...
            //verificar o numero de horas existentes
            foreach ($dir_hora as &$elemento )
            { 
                if (strcmp($elemento,"Loop")!=0)
                {
                    //output_file_name
                    $saida = '/temp/'.$_GET['tempo'].$_SERVER['REMOTE_ADDR'].$elemento.'.jpg'; 
                
                    // criando os caminhos para os diretorios. 
                    $dircb = $dir . '/imagem/' . $base .  '/base.png';
                    if (strcmp($camada1,"clean.png")!=0)
                        $dirc1=$dir . '/imagem/' . $data . '/' . $regiao . '/' . $elemento . '/' . $nivel . '/camada1/' . $camada1 . '.png';
                    else
                        $dirc1=$dir . '/imagem/clean/clean.png';
                        
                    if (strcmp($camada2,"clean.png")!=0)
                        $dirc2=$dir . '/imagem/' . $data . '/' . $regiao . '/' . $elemento . '/' . $nivel . '/camada2/' . $camada2 . '.png';
                    else
                        $dirc2=$dir . '/imagem/clean/clean.png';
                        
                    if (strcmp($camada3,"clean.png")!=0)
                        $dirc3=$dir . '/imagem/' . $data . '/' . $regiao . '/' . $elemento . '/' . $nivel . '/camada3/' . $camada3 . '.png';
                    else
                        $dirc3=$dir . '/imagem/clean/clean.png';

                    if (strcmp($camada4,"clean.png")!=0)
                        $dirc4=$dir . '/imagem/' . $data . '/' . $regiao . '/' . $elemento . '/' . $nivel . '/camada4/' . $camada4 . '.png';
                    else
                        $dirc4=$dir . '/imagem/clean/clean.png';
                        
                    if (strcmp($camada5,"clean.png")!=0)
                        $dirc5=$dir . '/imagem/' . $data . '/' . $regiao . '/' . $elemento . '/' . $nivel . '/camada5/' . $camada5 . '.png';
                    else
